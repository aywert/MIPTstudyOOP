...
void Controller::run(int num_of_silly_bots, int num_of_smart_bots, int num_of_human) {
...
void Controller::setSnakes(int num_of_silly_bots, int num_of_smart_bots, int num_of_human) {
